...
class TMDBClient : NSObject {
    ...
    func taskForGETMethod(method: String, parameters: [String:AnyObject], completionHandlerForGET: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        ...
        methodParameters[TMDBClient.ParameterKeys.ApiKey] = TMDBClient.Constants.ApiKey
        
        let request = NSURLRequest(URL: TMDBClient.tmdbURLFromParameters(methodParameters, withPathExtension: method))
    ...
    func taskForPOSTMethod(method: String, parameters: [String:AnyObject], jsonBody: String, completionHandlerForPOST: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        ...
        let request = NSMutableURLRequest(URL: TMDBClient.tmdbURLFromParameters(methodParameters, withPathExtension: method))
